...
if __name__ == '__main__':
    ...
    input_filename = '../augmented_catalog.csv'
    ...
    if not rows_to_fix.empty:
        ...
        # Use np.where for conditional calculation: if valid, divide; otherwise, use original price.
    ...
    output_filename = 'augmented_catalog_final.csv'
